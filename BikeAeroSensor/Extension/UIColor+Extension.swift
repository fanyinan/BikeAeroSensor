...
extension UIColor {
    ...
    static let theme = #colorLiteral(red: 0.5411764706, green: 0.3137254902, blue: 0.6, alpha: 1)
    ...
    static let text = #colorLiteral(red: 0.8745098039, green: 0.8745098039, blue: 0.8745098039, alpha: 1)
    static let subtext = #colorLiteral(red: 0.7638301253, green: 0.7673665881, blue: 0.7760055065, alpha: 1)
    static let button = #colorLiteral(red: 0.9294117647, green: 0.9294117647, blue: 0.9294117647, alpha: 1)
    static let mainBackground = #colorLiteral(red: 0.1019607843, green: 0.1019607843, blue: 0.1019607843, alpha: 1)
